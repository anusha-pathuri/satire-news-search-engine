...
from src.indexing import IndexType, InvertedIndex, BasicInvertedIndex, Indexer


DATASET_2_PATH = os.path.join(os.path.dirname(__file__), 'resources/dataset_2.jsonl')
...
class TestBasicInvertedIndex(unittest.TestCase):
    ...
    def test_add_doc(self):
        ...
        print('index after 1:', index.index)

        doc_id = 2
        tokens = ["apple", "banana", "cherry"]
        index.add_doc(doc_id, tokens)
        print('index after 2:', index.index)
...
class TestIndexer_BasicInvertedIndex(unittest.TestCase):
    ...
    def test_index_vocabularly(self):
        index = Indexer.create_index(self.index_type, DATASET_2_PATH, self.tokenizer, set(), 0)
        stats = index.get_statistics()
    ...
    def test_create_index_no_stopwords_with_mwf(self):
        ...
        index = Indexer.create_index(self.index_type, DATASET_2_PATH, self.tokenizer, set(), 2)
        stats = index.get_statistics()
    ...
    def test_create_index_with_stopwords_no_mwf(self):
        ...
        index = Indexer.create_index(self.index_type, DATASET_2_PATH, self.tokenizer, stopwords, 0)
        stats = index.get_statistics()
    ...
    def test_create_index_with_stopwords_with_mwf(self):
        ...
        index = Indexer.create_index(self.index_type, DATASET_2_PATH, self.tokenizer, stopwords, 2)
