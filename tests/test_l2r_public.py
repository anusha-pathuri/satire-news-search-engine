...
# Update the path to use absolute paths and point to src directory
...
class TestL2RRanker(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        with open('tests/resources/stopwords.txt', 'r', encoding='utf-8') as file:
        ...
        raw_text_dict = {}
        with open('tests/resources/dataset_1.jsonl', 'r', encoding='utf-8') as file:
            for line in file:
    ...
    def test_predict(self):
        ...
        l2r.train('tests/resources/data-relevance.csv')
...
class TestL2RFeatureExtractor(unittest.TestCase):
    ...
    def test_get_tf(self):
        ...
        docid_to_word_counts = self.get_doc_counts('tests/resources/dataset_1.jsonl')
